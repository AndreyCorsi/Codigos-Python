...
def criar_publicacao():
    ...
    conteudo = input("Digite o conteúdo de sua publicação: ")
    descricao = input("Digite a descrição da sua publicação: ")
    autor = input("Quem é o autor da publicação: ")
...
def visualizar_publicacoes_por_autor():
    ...
    if not lista_publicacoes:
        print("Nunhuma publicação disponível.")
        return
